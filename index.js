...
// Add multiple users - Just for sake of testing adding array of objects (bulk add)
...
api.get(routes.getAllUsers(), (request) => { // GET all users
  return dynamoDB.scan({ TableName: databaseTable.getUsersTableName() }).promise()
...
// api.get(routes.findUser(), (request) => { // GET a user by first name and last name
//   const firstName = request.queryStringParameters.firstName;
//   const lastName = request.queryStringParameters.lastName;
